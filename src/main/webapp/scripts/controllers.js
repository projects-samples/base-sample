...
spotgarageApp.controller('LanguageController', ['$scope', '$translate', 'LanguageService', 'FLAGS',
...
spotgarageApp.controller('SettingsController', ['$scope', 'Account',
...
spotgarageApp.controller('RegisterController', ['$scope', '$translate', 'Register',
...
spotgarageApp.controller('ActivationController', ['$scope', '$routeParams', 'Activate',
...
spotgarageApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 spotgarageApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
spotgarageApp.controller('MetricsController', ['$scope', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
...
spotgarageApp.controller('AuditsController', ['$scope', '$translate', '$filter', 'AuditsService',
