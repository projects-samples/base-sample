...
spotgarageApp.controller('MainController', function ($scope) {
    });

spotgarageApp.controller('AdminController', function ($scope) {
    });

spotgarageApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
spotgarageApp.controller('MenuController', function ($scope) {
    });

spotgarageApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
spotgarageApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

spotgarageApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
spotgarageApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
spotgarageApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
spotgarageApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
spotgarageApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 spotgarageApp.controller('TrackerController', ['AccessToken'], function ($scope, AccessToken) {
...
spotgarageApp.controller('HealthController', function ($scope, HealthCheckService) {
...
spotgarageApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

spotgarageApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
spotgarageApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
spotgarageApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
