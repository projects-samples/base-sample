...
import in.spotgarage.web.filter.CachingHttpHeadersFilter;
import in.spotgarage.web.filter.StaticResourcesProductionFilter;
import in.spotgarage.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "in.spotgarage.web.websocket");
