...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SpotGarage@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SpotGarage API";

        private String description = "SpotGarage API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SpotGarage";
