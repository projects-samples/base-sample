...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        log.info("Defining Infinispan Global Configuration");
            return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-SpotGarage-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(in.spotgarage.repository.UserRepository.USERS_BY_LOGIN_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.repository.UserRepository.USERS_BY_LOGIN_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.repository.UserRepository.USERS_BY_EMAIL_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.repository.UserRepository.USERS_BY_EMAIL_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.domain.PersistentToken.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.domain.PersistentToken.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(in.spotgarage.domain.User.class.getName() + ".persistentTokens", new JCache<Object, Object>(
                cacheManager.getCache(in.spotgarage.domain.User.class.getName() + ".persistentTokens").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
