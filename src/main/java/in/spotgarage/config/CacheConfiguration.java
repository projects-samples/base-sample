...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        ...
        return () ->
            GlobalConfigurationBuilder
                ...
                .clusterName("infinispan-SpotGarage-cluster")
                .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    in.spotgarage.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    in.spotgarage.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(cacheName ->
                    manager.defineConfiguration(
                        cacheName,
