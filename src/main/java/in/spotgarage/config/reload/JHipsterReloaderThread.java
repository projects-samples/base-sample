package in.spotgarage.config.reload;

import in.spotgarage.config.reload.reloader.JacksonReloader;
import in.spotgarage.config.reload.reloader.LiquibaseReloader;
import in.spotgarage.config.reload.reloader.SpringReloader;
    ...
    public void reloadEvent(String typename, Class<?> clazz) {
        synchronized (lock) {
            ...
            if (AnnotationUtils.findAnnotation(clazz, Repository.class) != null ||
                ...
                startReloading = true;
            } else if (typename.startsWith("in.spotgarage.domain")) {
            ...
            } else if (typename.startsWith("in.spotgarage.web.rest.dto")) {
