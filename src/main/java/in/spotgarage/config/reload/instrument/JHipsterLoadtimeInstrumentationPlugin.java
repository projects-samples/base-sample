package in.spotgarage.config.reload.instrument;
    ...
    public byte[] modify(String slashedClassName, ClassLoader classLoader, byte[] bytes) {
        ...
        try {
            ...
            if (StringUtils.equals(slashedClassName, "liquibase/ext/hibernate/snapshot/TableSnapshotGenerator")) {
                ...
                ctClass.setSuperclass(classPool.get("in.spotgarage.config.reload.patch.liquibase.JHipsterTableSnapshotGenerator"));
            ...
            if (StringUtils.equals(slashedClassName, "org/hibernate/jpa/HibernatePersistenceProvider")) {
                ...
                ctClass.setSuperclass(classPool.get("in.spotgarage.config.reload.instrument.hibernate.JHipsterPersistenceProvider"));
