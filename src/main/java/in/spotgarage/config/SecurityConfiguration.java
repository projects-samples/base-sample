...
import in.spotgarage.config.reload.condition.ConditionalOnSpringLoaded;
import in.spotgarage.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
        return new in.spotgarage.security.UserDetailsService();
    }
