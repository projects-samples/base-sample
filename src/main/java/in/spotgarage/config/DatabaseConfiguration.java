...
@Configuration
@EnableJpaRepositories("in.spotgarage.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "in.spotgarage.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("in.spotgarage.domain");
        return basePackages;
    }
