...
describe('Company e2e test', () => {
  ...
  it('should load Companies', async () => {
    ...
    expect(await companyComponentsPage.getTitle()).to.eq('spotGarageApp.company.home.title');
  });
  ...
  it('should load create Company page', async () => {
    ...
    expect(await companyUpdatePage.getPageTitle()).to.eq('spotGarageApp.company.home.createOrEditLabel');
  ...
  it('should delete last Company', async () => {
    ...
    expect(await companyDeleteDialog.getDialogTitle()).to.eq('spotGarageApp.company.delete.question');
