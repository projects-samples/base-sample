...
public class SpotGarageKafkaResourceIT {
    ...
    @Autowired
    private SpotGarageKafkaProducer producer;

    @Autowired
    private SpotGarageKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        SpotGarageKafkaResource kafkaResource = new SpotGarageKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/spot-garage-kafka/publish?message=test"))
