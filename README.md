...
To build the final jar and optimize the SpotGarage application for production, run:
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v7.0.0-beta.0/doing-api-first-development/
